...
.. code-block:: console
   ...
   $rclone --multi-thread-streams 1 --timeout=240m --no-traverse copy mydir dcache:rclone-test
...
For more information, see the dCache User Guide: https://dcache.org/manuals/UserGuide-10.2/macaroons.shtml
